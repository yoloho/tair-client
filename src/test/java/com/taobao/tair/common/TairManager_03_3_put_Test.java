...
public class TairManager_03_3_put_Test extends BaseTest {
	...
	public void test_301_data_not_exist_qa() {
        ...
        ResultCode resultCode = tairManager.put(namespace, key1, value1,1,0);
        ...
        resultCode = tairManager.put(namespace+1, key, value2,0,0);
        Assert.assertTrue(resultCode.isSuccess());
        Assert.assertEquals(ResultCode.SUCCESS,resultCode);
        ...
        resultCode = tairManager.put(namespace, key, value,-1,2);
        Assert.assertTrue(resultCode.isSuccess());
        Assert.assertEquals(ResultCode.SUCCESS,resultCode);
	...
	public void test_303_data_not_exist_namespace_equals_0_qa() {
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,Integer.MAX_VALUE,4);
	    Assert.assertTrue(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode);    
	...
	public void test_304_data_not_exist_namespace_equals_1023_qa() {
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,Integer.MIN_VALUE-1,5);
	    Assert.assertTrue(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode);       
	...
	public void test_305_data_not_exist_namespace_equals_1024_qa() {
		...
		tairManager.delete(namespace, key);
		ResultCode result = tairManager.put(namespace, key, value,Integer.MAX_VALUE+1,5);
	...
	@Test
	public void test_305_2_data_not_exist_namespace_equals_65536_qa() {
	...
	public void test_306_data_not_exist_key_equals_null_qa() {
		...
		ResultCode resultCode = tairManager.put(namespace, key, value,1,5);
		Assert.assertFalse(resultCode.isSuccess());  
	...
	public void test_306_1_data_not_exist_key_equals_empty_string_qa() {
		...
		String value = "326_data_1";
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,Integer.MAX_VALUE+1,5);
	    Assert.assertTrue(resultCode.isSuccess());  
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode); 
	...
	public void test_308_data_exist_old_date_version_not_equals_0_version_equals_qa(){
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,2,5);
	    Assert.assertTrue(resultCode.isSuccess()); 
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode);
		...
		value = "328_data_2";
		resultCode = tairManager.put(namespace, key, value,1,6);
		Assert.assertTrue(resultCode.isSuccess()); 
		Assert.assertEquals(ResultCode.SUCCESS, resultCode);
	...
	public void test_309_data_exist_old_date_version_not_equals_0_version_bigger_than__qa(){
		...
		resultCode = tairManager.put(namespace, key, value2,2,5);
		Assert.assertFalse(resultCode.isSuccess()); 
	...
	public void test_310_data_exist_old_date_version_not_equals_0_version_less_than__qa(){
		...
		String value2 = "328_data_2";
		resultCode = tairManager.put(namespace, key, value2,1,6);
		Assert.assertFalse(resultCode.isSuccess()); 
		Assert.assertEquals(ResultCode.VERERROR, resultCode);
	...
	@Test
	public void test_311_data_exist_data_expired_qa() throws InterruptedException{
		...
		value = "311_data_2";
		resultCode = tairManager.put(namespace, key, value,3,2);
	...
	public void test_312_key_size_test_data_not_exist_key_less_than_1k_qa() throws InterruptedException{
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,1,2);
	    Assert.assertTrue(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode);
	...
	public void test_314_key_size_test_data_not_exist_key_bigger_than_1k_qa() throws InterruptedException{
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,2,2);
	    Assert.assertFalse(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.KEYTOLARGE, resultCode);
	...
	public void test_315_data_size_test_data_not_exist_data_less_than_one_million_bytes_qa() throws InterruptedException{
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,3,2);
	    Assert.assertTrue(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode);
	...
	public void test_316_data_size_test_data_not_exist_data_equals_one_million_bytes_qa() throws InterruptedException{
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,4,2);
	    Assert.assertFalse(resultCode.isSuccess());
	...
	public void test_317_data_size_test_data_not_exist_data_bigger_than_one_million_bytes_qa() throws InterruptedException{
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,5,3);
	    Assert.assertFalse(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.VALUETOLARGE, resultCode);
	...
	public void test_318_data_size_test_data_exist_argument_data_bigger_than_one_million_bytes_qa() throws InterruptedException{
		...
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,6,4);
	    Assert.assertTrue(resultCode.isSuccess());
	    Assert.assertEquals(ResultCode.SUCCESS, resultCode);
	...
	@Test
	public void test_319_data_exist_expiretimenegative_qa() throws InterruptedException{
		String key = "311_key_1";
		String value = "311_data_1";
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,2,5);
		...
		value = "311_data_2";
		resultCode = tairManager.put(namespace, key, value,1,-1);
		Assert.assertFalse(resultCode.isSuccess());
	...
	@Test
	public void test_320_data_not_exist_expiretimenegative_qa() throws InterruptedException{
		String key = "311_key_1";
		String value = "311_data_1";
		tairManager.delete(namespace, key);
		ResultCode resultCode = tairManager.put(namespace, key, value,1,-1);
		Assert.assertFalse(resultCode.isSuccess());
		Assert.assertEquals(ResultCode.INVALIDARG, resultCode);
